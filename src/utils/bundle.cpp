...
kiwi::Bundle::Bundle(const unsigned int cap) { newPackBuffer(cap); }
...
kiwi::byte *kiwi::Bundle::getPackedData() { return buffer; }

unsigned int kiwi::Bundle::getPackedDataCap() { return cap; }
