...
namespace kiwi {
  ...
  public:
     ...
     * Detach means the runner is removed from message looper (messages will not be received), and this runner object
     * will be destroyed.
     */
     ...
     */
    virtual bool shouldDetach() const { return true; };
