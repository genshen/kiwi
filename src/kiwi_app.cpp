...
void kiwi::kiwiApp::setMPIThreadSupport(short type) { _mpi_thread_type = type; }
...
bool kiwi::kiwiApp::beforeCreate(int argc, char *argv[]) { return true; }
...
bool kiwi::kiwiApp::prepare() { return true; }
...
void kiwi::kiwiApp::destroy() { mpiUtils::finishMPI(); }

void kiwi::kiwiApp::abort(int code) { MPI_Abort(MPI_COMM_WORLD, code); }
