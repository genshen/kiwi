...
namespace kiwi {
  ...
  public:
    ...
    // success
    template <class... Types> inline static void s(const char *tag, const char *format, Types... args) {
      out_log("[S]", COLOR_R_GREEN, tag, format, args...);
    }

    // information
    template <class... Types> inline static void i(const char *tag, const char *format, Types... args) {
      out_log("[I]", COLOR_R_BLUE, tag, format, args...);
    }

    // VERBOSE
    template <class... Types> inline static void v(const char *tag, const char *format, Types... args) {
      out_log("[V]", COLOR_CLEAR, tag, format, args...);
    }

    // warning
    template <class... Types> inline static void w(const char *tag, const char *format, Types... args) {
      out_log("[W]", COLOR_R_ORANGE, tag, format, args...);
    }

    // error
    template <class... Types> inline static void e(const char *tag, const char *format, Types... args) {
      out_log("[E]", COLOR_R_RED, tag, format, args...);
    }

    // debug
    template <class... Types> inline static void d(const char *tag, const char *format, Types... args) {
  ...
  private:
    ...
    template <class... Types>
    static void out_log(const char *level, const char *level_color, const char *tag, const char *format,
                        Types... args) {
